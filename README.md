...
[View the Tableau Dashboard](https://public.tableau.com/views/Total_Revenue_Shopping_Events/Total_Revenue_Event?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
